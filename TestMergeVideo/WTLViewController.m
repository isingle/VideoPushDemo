...
//        
        ...
        [firstlayerInstruction setTransformRampFromStartTransform:CGAffineTransformIdentity toEndTransform:CGAffineTransformMakeTranslation(-[UIScreen mainScreen].bounds.size.width, 0) timeRange:CMTimeRangeMake(CMTimeMakeWithSeconds(6.0, 30), CMTimeMakeWithSeconds(7.0, 30))];
...
//        [secondlayerInstruction setOpacityRampFromStartOpacity:0.7 toEndOpacity:0.2 timeRange:CMTimeRangeMake(kCMTimeZero, firstAsset.duration)];
        ...
        [secondlayerInstruction setTransformRampFromStartTransform:CGAffineTransformMakeTranslation([UIScreen mainScreen].bounds.size.width, 0) toEndTransform:CGAffineTransformIdentity timeRange:CMTimeRangeMake(CMTimeMakeWithSeconds(7.0, 30), CMTimeMakeWithSeconds(8.0, 30))];
